...
function(modal) {
    function ajaxifyLinks (context) {
        $('a.report-choice', context).click(function() {
    ...
    var searchUrl = $('form.report-search', modal.body).attr('action');
    function search() {
        $.ajax({
            url: searchUrl,
            data: {
    ...
    $('form.report-upload', modal.body).submit(function() {
    ...
    $('form.report-search', modal.body).submit(search);
